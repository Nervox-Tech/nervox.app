              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="flex-1 relative">
                  <input
                    ...
                    placeholder={
                      isMobile ? 'Ask AI...' : "Try: 'Create a task for...' or 'Summarize my week'"
                    }
          ...
          >
            <Card className="h-full">
              ...
              <CardContent className="space-y-3">
                ...
                <SimplifiedTaskCreation placeholder="Add a new task..." className="mb-4" />
