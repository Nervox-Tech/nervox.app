    ...
    <div className="h-full flex flex-col bg-background">
      <div className="p-4 space-y-4 shrink-0">
        ...
        <Link to={ROUTE_PATH.INBOX.WHATSAPP}>
          <button className="w-full p-3 rounded-xl border border-platform-whatsapp/30 bg-platform-whatsapp/5 flex items-center gap-3 hover:bg-platform-whatsapp/10 transition-colors text-left mb-4 cursor-pointer">
