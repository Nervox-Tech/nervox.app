...
const INITIAL_MESSAGES: Record<string, Message[]> = {
  '1': [
    { id: 'm1', senderId: '1', text: 'Hi, are we still on track for the web design updates?', timestamp: '10:00 AM', isMe: false },
    { id: 'm2', senderId: '1', text: 'Would love to see the progress.', timestamp: '10:05 AM', isMe: false },
  ],
  '2': [
    { id: 'm3', senderId: '2', text: 'Do you need that design asset by EOD?', timestamp: 'Yesterday', isMe: false },
  ],
  '3': [
    { id: 'm4', senderId: '3', text: 'Just following up on the invoice sent last week.', timestamp: '2 days ago', isMe: false },
  ]
};
...
export const useInboxStore = create<InboxState>((set, get) => ({
  ...
  setActiveThreadId: (id) => set({ activeThreadId: id, isEditingDraft: false, mobileView: 'thread' }),
  setIsEditingDraft: (isEditing) => set({ isEditingDraft: isEditing }),

  setDraft: (threadId, content) => set((state) => ({
